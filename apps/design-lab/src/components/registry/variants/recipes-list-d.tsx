...
export const RecipesListD = () => {
	...
	return (
		<section aria-labelledby="recipes-d-title" className="mx-auto max-w-3xl">
			<div className="flex flex-wrap items-end justify-between gap-3">
				<div>
					<Text variant="detail" className="tracking-widest uppercase">
						Your library
					</Text>
					<Heading as="h1" variant="title" id="recipes-d-title" className="mt-1">
						Recipes
					</Heading>
				</div>
