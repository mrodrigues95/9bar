...
export const Middle: Story = {
	render: () => (
		<div className="w-96 rounded-lg border border-slate-200">
...
export const ListExample: Story = {
	render: () => (
		<div className="w-96 rounded-lg border border-slate-200 bg-white">
			<div className="flex items-center justify-between p-4">
				<div>
					<div className="font-medium text-sm">John Doe</div>
					<div className="text-slate-500 text-xs">john@example.com</div>
				</div>
			</div>
			<Divider />
			<div className="flex items-center justify-between p-4">
			...
			<div className="flex items-center justify-between p-4">
				<div>
					...
					<div className="text-slate-500 text-xs">bob@example.com</div>
				</div>
			</div>
		</div>
	),
...
export const VerticalToolbar: Story = {
	render: () => (
		<div className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white p-2">
